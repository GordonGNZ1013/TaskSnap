...
#include "../../QTwondor/TaskSnap/notificationmanager.h"
...
template <> constexpr inline auto NotificationManager::qt_create_metaobjectdata<qt_meta_tag_ZN19NotificationManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_enums {
        ...
        QtMocHelpers::EnumData<NotificationType>(7, 7, QMC::EnumFlags{}).add({
            {    8, NotificationType::TaskReminder },
            {    9, NotificationType::TaskOverdue },
            {   10, NotificationType::PomodoroComplete },
            {   11, NotificationType::BreakComplete },
        }),
    };
...
void NotificationManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->reminderTriggered((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 1: _t->overdueTaskDetected((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        case 2: _t->checkReminders(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NotificationManager::*)(int , const QString & )>(_a, &NotificationManager::reminderTriggered, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (NotificationManager::*)(int , const QString & )>(_a, &NotificationManager::overdueTaskDetected, 1))
            return;
    }
}
...
// SIGNAL 0
void NotificationManager::reminderTriggered(int _t1, const QString & _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void NotificationManager::overdueTaskDetected(int _t1, const QString & _t2)
{
